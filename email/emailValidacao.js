...
<body>
    <div class="container">
        <!-- Área de Bem-Vindo -->
        <div class="header">
            <img class="logo" src="logo.png" alt="Logo da Minha Empresa">
        </div>
        ...
        <div class="validate-button-container">
            <a href="URL_PARA_VALIDAR_A_CONTA" class="validate-button" style="text-decoration: none; color: #ffffff;">Valide Agora</a>
        </div>
    </div>
</body>
</html>`;
